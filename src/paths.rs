...
pub struct FileLocations {
    ...
    #[serde(default = "default_self_cluster_id_config")]
    pub self_cluster_id_config: String,
...
fn default_self_cluster_id_config() -> String { "/etc/wolfstack/self_cluster_id.json".into() }
