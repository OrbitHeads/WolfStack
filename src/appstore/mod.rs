...
pub fn built_in_catalogue() -> Vec<AppManifest> {
    vec![
        ...
        AppManifest { id: "airsonic".into(), name: "Airsonic Advanced".into(), icon: "🎵".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "airsonicadvanced/airsonic-advanced:latest".into(), ports: vec!["4040:4040".into()], env: vec![], volumes: vec!["airsonic_data:/var/airsonic".into(), "${MUSIC_PATH}:/music:ro".into()], sidecars: vec![] }),
        ...
        AppManifest { id: "funkwhale".into(), name: "Funkwhale".into(), icon: "🐋".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "funkwhale/all-in-one:latest".into(), ports: vec!["5000:80".into()], env: vec![], volumes: vec!["funkwhale_data:/data".into(), "${MUSIC_PATH}:/music:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "MUSIC_PATH".into(), label: "Music Path".into(), input_type: "text".into(), default: Some("/opt/media/music".into()), required: true, placeholder: None, options: vec![] },
            ],
        },
        AppManifest { id: "dim".into(), name: "Dim".into(), icon: "🎞️".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/dusk-labs/dim:latest".into(), ports: vec!["8000:8000".into()], env: vec![], volumes: vec!["dim_config:/opt/dim/config".into(), "${MEDIA_PATH}:/media".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "MEDIA_PATH".into(), label: "Media Path".into(), input_type: "text".into(), default: Some("/opt/media".into()), required: true, placeholder: None, options: vec![] },
            ],
        },
        AppManifest { id: "tubesync".into(), name: "TubeSync".into(), icon: "📥".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/meeb/tubesync:latest".into(), ports: vec!["4848:4848".into()], env: vec![], volumes: vec!["tubesync_config:/config".into(), "tubesync_downloads:/downloads".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "readarr".into(), name: "Readarr".into(), icon: "📖".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/readarr:develop".into(), ports: vec!["8787:8787".into()], env: vec!["PUID=1000".into(), "PGID=1000".into(), "TZ=UTC".into()], volumes: vec!["readarr_config:/config".into(), "${BOOKS_PATH}:/books".into(), "${DOWNLOAD_PATH}:/downloads".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "BOOKS_PATH".into(), label: "Books Path".into(), input_type: "text".into(), default: Some("/opt/media/books".into()), required: true, placeholder: None, options: vec![] },
                UserInput { id: "DOWNLOAD_PATH".into(), label: "Downloads Path".into(), input_type: "text".into(), default: Some("/opt/downloads".into()), required: true, placeholder: None, options: vec![] },
            ],
        ...
        AppManifest { id: "komga".into(), name: "Komga".into(), icon: "📚".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "gotson/komga:latest".into(), ports: vec!["25600:25600".into()], env: vec![], volumes: vec!["komga_config:/config".into(), "${LIBRARY_PATH}:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "photoview".into(), name: "Photoview".into(), icon: "🖼️".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "viktorstrate/photoview:latest".into(), ports: vec!["8080:80".into()], env: vec!["PHOTOVIEW_SQLITE_PATH=/data/photoview.db".into()], volumes: vec!["photoview_data:/data".into(), "${PHOTOS_PATH}:/photos:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "PHOTOS_PATH".into(), label: "Photos Path".into(), input_type: "text".into(), default: Some("/opt/photos".into()), required: true, placeholder: None, options: vec![] },
            ],
        },
        AppManifest { id: "lychee".into(), name: "Lychee".into(), icon: "🍒".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "lycheeorg/lychee:latest".into(), ports: vec!["8090:80".into()], env: vec!["DB_CONNECTION=sqlite".into(), "DB_DATABASE=/data/lychee.sqlite".into()], volumes: vec!["lychee_config:/conf".into(), "lychee_uploads:/uploads".into(), "lychee_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "freshrss".into(), name: "FreshRSS".into(), icon: "📰".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "freshrss/freshrss:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["freshrss_data:/var/www/FreshRSS/data".into(), "freshrss_extensions:/var/www/FreshRSS/extensions".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "wallabag".into(), name: "Wallabag".into(), icon: "📑".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "wallabag/wallabag:latest".into(), ports: vec!["8080:80".into()], env: vec!["SYMFONY__ENV__DOMAIN_NAME=http://localhost:8080".into()], volumes: vec!["wallabag_data:/var/www/wallabag/data".into(), "wallabag_images:/var/www/wallabag/web/assets/images".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "onlyoffice".into(), name: "ONLYOFFICE Docs".into(), icon: "📄".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "onlyoffice/documentserver:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["onlyoffice_data:/var/www/onlyoffice/Data".into(), "onlyoffice_log:/var/log/onlyoffice".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "collabora".into(), name: "Collabora Online".into(), icon: "📝".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "collabora/code:latest".into(), ports: vec!["9980:9980".into()], env: vec!["extra_params=--o:ssl.enable=false".into()], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "cryptpad".into(), name: "CryptPad".into(), icon: "🔒".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "promasu/cryptpad:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec!["cryptpad_blob:/cryptpad/blob".into(), "cryptpad_block:/cryptpad/block".into(), "cryptpad_data:/cryptpad/datastore".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "vikunja-cal".into(), name: "Radicale".into(), icon: "📅".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "tomsquest/docker-radicale:latest".into(), ports: vec!["5232:5232".into()], env: vec![], volumes: vec!["radicale_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "baikal".into(), name: "Baikal".into(), icon: "📇".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "ckulka/baikal:nginx".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["baikal_config:/var/www/baikal/config".into(), "baikal_data:/var/www/baikal/Specific".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "linkwarden".into(), name: "Linkwarden".into(), icon: "🔖".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/linkwarden/linkwarden:latest".into(), ports: vec!["3000:3000".into()], env: vec!["DATABASE_URL=postgresql://postgres:${DB_PASSWORD}@linkwarden-db:5432/linkwarden".into(), "NEXTAUTH_SECRET=${SECRET_KEY}".into(), "NEXTAUTH_URL=http://localhost:3000".into()], volumes: vec!["linkwarden_data:/data".into()], sidecars: vec![DockerSidecar { name_suffix: "db".into(), image: "postgres:15-alpine".into(), ports: vec![], env: vec!["POSTGRES_DB=linkwarden".into(), "POSTGRES_PASSWORD=${DB_PASSWORD}".into()], volumes: vec!["linkwarden_db:/var/lib/postgresql/data".into()] }] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "DB_PASSWORD".into(), label: "Database Password".into(), input_type: "password".into(), default: None, required: true, placeholder: Some("PostgreSQL password".into()), options: vec![] },
        ...
        AppManifest { id: "shiori".into(), name: "Shiori".into(), icon: "📌".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/go-shiori/shiori:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["shiori_data:/shiori".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "docuseal".into(), name: "DocuSeal".into(), icon: "✍️".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "docuseal/docuseal:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec!["docuseal_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "kimai".into(), name: "Kimai".into(), icon: "⏱️".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "kimai/kimai2:latest".into(), ports: vec!["8001:8001".into()], env: vec!["DATABASE_URL=sqlite:////opt/kimai/var/data/kimai.sqlite".into()], volumes: vec!["kimai_data:/opt/kimai/var/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "gitlab".into(), name: "GitLab CE".into(), icon: "🦊".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "gitlab/gitlab-ce:latest".into(), ports: vec!["8080:80".into(), "8443:443".into(), "2222:22".into()], env: vec![], volumes: vec!["gitlab_config:/etc/gitlab".into(), "gitlab_logs:/var/log/gitlab".into(), "gitlab_data:/var/opt/gitlab".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "forgejo".into(), name: "Forgejo".into(), icon: "🏗️".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "codeberg.org/forgejo/forgejo:latest".into(), ports: vec!["3000:3000".into(), "2222:22".into()], env: vec![], volumes: vec!["forgejo_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "coder".into(), name: "Coder".into(), icon: "💻".into(), category: "Dev Tools".into(),
            ...
            website: Some("https://coder.com".into()),
            docker: Some(DockerTarget { image: "ghcr.io/coder/coder:latest".into(), ports: vec!["7080:7080".into()], env: vec!["CODER_ACCESS_URL=http://localhost:7080".into()], volumes: vec!["coder_data:/home/coder/.config/coderv2".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "devcontainers".into(), name: "OpenVSCode Server".into(), icon: "📟".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "gitpod/openvscode-server:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec!["openvscode_data:/home/workspace".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "httpbin".into(), name: "httpbin".into(), icon: "🌐".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "kennethreitz/httpbin:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "mailhog".into(), name: "MailHog".into(), icon: "📬".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "mailhog/mailhog:latest".into(), ports: vec!["1025:1025".into(), "8025:8025".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "swagger-editor".into(), name: "Swagger Editor".into(), icon: "📋".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "swaggerapi/swagger-editor:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "snippet-box".into(), name: "Snippet Box".into(), icon: "📋".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "pawelmalak/snippet-box:latest".into(), ports: vec!["5000:5000".into()], env: vec![], volumes: vec!["snippetbox_data:/app/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "kroki".into(), name: "Kroki".into(), icon: "📊".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "yuzutech/kroki:latest".into(), ports: vec!["8000:8000".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "act".into(), name: "Nektos Act".into(), icon: "🎭".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "catthehacker/ubuntu:act-latest".into(), ports: vec![], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "clickhouse".into(), name: "ClickHouse".into(), icon: "🏎️".into(), category: "Database".into(),
            ...
            docker: Some(DockerTarget { image: "clickhouse/clickhouse-server:latest".into(), ports: vec!["8123:8123".into(), "9000:9000".into()], env: vec![], volumes: vec!["clickhouse_data:/var/lib/clickhouse".into(), "clickhouse_logs:/var/log/clickhouse-server".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "cassandra".into(), name: "Apache Cassandra".into(), icon: "👁️".into(), category: "Database".into(),
            ...
            docker: Some(DockerTarget { image: "cassandra:latest".into(), ports: vec!["9042:9042".into()], env: vec![], volumes: vec!["cassandra_data:/var/lib/cassandra".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "neo4j".into(), name: "Neo4j".into(), icon: "🕸️".into(), category: "Database".into(),
            ...
            docker: Some(DockerTarget { image: "neo4j:latest".into(), ports: vec!["7474:7474".into(), "7687:7687".into()], env: vec!["NEO4J_AUTH=neo4j/${NEO4J_PASSWORD}".into()], volumes: vec!["neo4j_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "surrealdb".into(), name: "SurrealDB".into(), icon: "🚀".into(), category: "Database".into(),
            ...
            docker: Some(DockerTarget { image: "surrealdb/surrealdb:latest".into(), ports: vec!["8000:8000".into()], env: vec![], volumes: vec!["surrealdb_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "valkey".into(), name: "Valkey".into(), icon: "🔑".into(), category: "Database".into(),
            ...
            docker: Some(DockerTarget { image: "valkey/valkey:latest".into(), ports: vec!["6379:6379".into()], env: vec![], volumes: vec!["valkey_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "keydb".into(), name: "KeyDB".into(), icon: "⚡".into(), category: "Database".into(),
            ...
            docker: Some(DockerTarget { image: "eqalpha/keydb:latest".into(), ports: vec!["6379:6379".into()], env: vec![], volumes: vec!["keydb_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "dragonfly".into(), name: "Dragonfly".into(), icon: "🐉".into(), category: "Database".into(),
            ...
            docker: Some(DockerTarget { image: "docker.dragonflydb.io/dragonflydb/dragonfly:latest".into(), ports: vec!["6379:6379".into()], env: vec![], volumes: vec!["dragonfly_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "questdb".into(), name: "QuestDB".into(), icon: "📈".into(), category: "Database".into(),
            ...
            docker: Some(DockerTarget { image: "questdb/questdb:latest".into(), ports: vec!["9000:9000".into(), "9009:9009".into(), "8812:8812".into()], env: vec![], volumes: vec!["questdb_data:/var/lib/questdb".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "timescaledb".into(), name: "TimescaleDB".into(), icon: "⏰".into(), category: "Database".into(),
            ...
            docker: Some(DockerTarget { image: "timescale/timescaledb:latest-pg15".into(), ports: vec!["5432:5432".into()], env: vec!["POSTGRES_PASSWORD=${DB_PASSWORD}".into()], volumes: vec!["timescaledb_data:/var/lib/postgresql/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "arangodb".into(), name: "ArangoDB".into(), icon: "🥑".into(), category: "Database".into(),
            ...
            docker: Some(DockerTarget { image: "arangodb:latest".into(), ports: vec!["8529:8529".into()], env: vec!["ARANGO_ROOT_PASSWORD=${ROOT_PASSWORD}".into()], volumes: vec!["arangodb_data:/var/lib/arangodb3".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "pihole-unbound".into(), name: "Pi-hole + Unbound".into(), icon: "🔒".into(), category: "Networking".into(),
            ...
            website: Some("https://pi-hole.net".into()),
            docker: Some(DockerTarget { image: "cbcrowe/pihole-unbound:latest".into(), ports: vec!["53:53/tcp".into(), "53:53/udp".into(), "8080:80".into()], env: vec!["WEBPASSWORD=${ADMIN_PASSWORD}".into(), "TZ=UTC".into()], volumes: vec!["pihole_unbound_etc:/etc/pihole".into(), "pihole_unbound_dns:/etc/dnsmasq.d".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "technitium".into(), name: "Technitium DNS".into(), icon: "🌐".into(), category: "Networking".into(),
            ...
            docker: Some(DockerTarget { image: "technitium/dns-server:latest".into(), ports: vec!["5380:5380".into(), "53:53/udp".into(), "53:53/tcp".into()], env: vec![], volumes: vec!["technitium_data:/etc/dns".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "ddclient".into(), name: "ddclient".into(), icon: "🔄".into(), category: "Networking".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/ddclient:latest".into(), ports: vec![], env: vec!["PUID=1000".into(), "PGID=1000".into(), "TZ=UTC".into()], volumes: vec!["ddclient_config:/config".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "duckdns".into(), name: "DuckDNS".into(), icon: "🦆".into(), category: "Networking".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/duckdns:latest".into(), ports: vec![], env: vec!["SUBDOMAINS=${SUBDOMAIN}".into(), "TOKEN=${DUCKDNS_TOKEN}".into(), "TZ=UTC".into()], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "caddy".into(), name: "Caddy".into(), icon: "🔒".into(), category: "Networking".into(),
            ...
            docker: Some(DockerTarget { image: "caddy:latest".into(), ports: vec!["80:80".into(), "443:443".into()], env: vec![], volumes: vec!["caddy_data:/data".into(), "caddy_config:/config".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "haproxy".into(), name: "HAProxy".into(), icon: "⚖️".into(), category: "Networking".into(),
            ...
            docker: Some(DockerTarget { image: "haproxy:latest".into(), ports: vec!["80:80".into(), "443:443".into(), "8404:8404".into()], env: vec![], volumes: vec!["haproxy_config:/usr/local/etc/haproxy:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "ntopng".into(), name: "ntopng".into(), icon: "📡".into(), category: "Networking".into(),
            ...
            docker: Some(DockerTarget { image: "ntop/ntopng:stable".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec!["ntopng_data:/var/lib/ntopng".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "fail2ban".into(), name: "Fail2ban".into(), icon: "🚫".into(), category: "Security".into(),
            ...
            docker: Some(DockerTarget { image: "crazymax/fail2ban:latest".into(), ports: vec![], env: vec!["TZ=UTC".into()], volumes: vec!["fail2ban_data:/data".into(), "/var/log:/var/log:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "clamav".into(), name: "ClamAV".into(), icon: "🦠".into(), category: "Security".into(),
            ...
            docker: Some(DockerTarget { image: "clamav/clamav:latest".into(), ports: vec!["3310:3310".into()], env: vec![], volumes: vec!["clamav_data:/var/lib/clamav".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "trivy".into(), name: "Trivy".into(), icon: "🔍".into(), category: "Security".into(),
            ...
            docker: Some(DockerTarget { image: "aquasec/trivy:latest".into(), ports: vec![], env: vec![], volumes: vec!["trivy_cache:/root/.cache/trivy".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "defectdojo".into(), name: "DefectDojo".into(), icon: "🐛".into(), category: "Security".into(),
            ...
            docker: Some(DockerTarget { image: "defectdojo/defectdojo-django:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["defectdojo_data:/app/media".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "headscale".into(), name: "Headscale".into(), icon: "🐍".into(), category: "Security".into(),
            ...
            docker: Some(DockerTarget { image: "headscale/headscale:latest".into(), ports: vec!["8080:8080".into(), "9090:9090".into()], env: vec![], volumes: vec!["headscale_data:/var/lib/headscale".into(), "headscale_config:/etc/headscale".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "beszel".into(), name: "Beszel".into(), icon: "📊".into(), category: "Monitoring".into(),
            ...
            docker: Some(DockerTarget { image: "henrygd/beszel:latest".into(), ports: vec!["8090:8090".into()], env: vec![], volumes: vec!["beszel_data:/beszel_data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "dozzle".into(), name: "Dozzle".into(), icon: "🪵".into(), category: "Monitoring".into(),
            ...
            docker: Some(DockerTarget { image: "amir20/dozzle:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["/var/run/docker.sock:/var/run/docker.sock:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "watchtower".into(), name: "Watchtower".into(), icon: "🗼".into(), category: "Monitoring".into(),
            ...
            docker: Some(DockerTarget { image: "containrrr/watchtower:latest".into(), ports: vec![], env: vec!["WATCHTOWER_CLEANUP=true".into(), "WATCHTOWER_SCHEDULE=0 0 4 * * *".into()], volumes: vec!["/var/run/docker.sock:/var/run/docker.sock".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "diun".into(), name: "Diun".into(), icon: "🔔".into(), category: "Monitoring".into(),
            ...
            docker: Some(DockerTarget { image: "crazymax/diun:latest".into(), ports: vec![], env: vec!["LOG_LEVEL=info".into(), "LOG_JSON=false".into()], volumes: vec!["diun_data:/data".into(), "/var/run/docker.sock:/var/run/docker.sock:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "scrutiny".into(), name: "Scrutiny".into(), icon: "💽".into(), category: "Monitoring".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/analogj/scrutiny:master-omnibus".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["scrutiny_config:/opt/scrutiny/config".into(), "scrutiny_db:/opt/scrutiny/influxdb".into(), "/run/udev:/run/udev:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "monitoror".into(), name: "Monitoror".into(), icon: "📺".into(), category: "Monitoring".into(),
            ...
            docker: Some(DockerTarget { image: "monitoror/monitoror:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["monitoror_config:/config".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "activepieces".into(), name: "Activepieces".into(), icon: "🧩".into(), category: "Automation".into(),
            ...
            docker: Some(DockerTarget { image: "activepieces/activepieces:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["activepieces_data:/root/.activepieces".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "windmill".into(), name: "Windmill".into(), icon: "🌀".into(), category: "Automation".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/windmill-labs/windmill:main".into(), ports: vec!["8000:8000".into()], env: vec!["DATABASE_URL=postgres://postgres:${DB_PASSWORD}@windmill-db/windmill".into()], volumes: vec![], sidecars: vec![DockerSidecar { name_suffix: "db".into(), image: "postgres:15-alpine".into(), ports: vec![], env: vec!["POSTGRES_DB=windmill".into(), "POSTGRES_PASSWORD=${DB_PASSWORD}".into()], volumes: vec!["windmill_db:/var/lib/postgresql/data".into()] }] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "DB_PASSWORD".into(), label: "Database Password".into(), input_type: "password".into(), default: None, required: true, placeholder: Some("PostgreSQL password".into()), options: vec![] },
            ],
        },
        AppManifest { id: "automatisch".into(), name: "Automatisch".into(), icon: "⚙️".into(), category: "Automation".into(),
            ...
            docker: Some(DockerTarget { image: "automatischio/automatisch:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec!["automatisch_data:/automatisch/storage".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "revolt".into(), name: "Revolt".into(), icon: "💬".into(), category: "Communication".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/revoltchat/server:latest".into(), ports: vec!["8000:8000".into()], env: vec![], volumes: vec!["revolt_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "mumble".into(), name: "Mumble Server".into(), icon: "🎙️".into(), category: "Communication".into(),
            ...
            docker: Some(DockerTarget { image: "mumblevoip/mumble-server:latest".into(), ports: vec!["64738:64738".into(), "64738:64738/udp".into()], env: vec!["MUMBLE_SUPERUSER_PASSWORD=${ADMIN_PASSWORD}".into()], volumes: vec!["mumble_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "teamspeak".into(), name: "TeamSpeak".into(), icon: "🎧".into(), category: "Communication".into(),
            ...
            docker: Some(DockerTarget { image: "teamspeak:latest".into(), ports: vec!["9987:9987/udp".into(), "10011:10011".into(), "30033:30033".into()], env: vec!["TS3SERVER_LICENSE=accept".into()], volumes: vec!["teamspeak_data:/var/ts3server".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "typebot".into(), name: "Typebot".into(), icon: "🤖".into(), category: "Communication".into(),
            ...
            docker: Some(DockerTarget { image: "baptistearno/typebot-builder:latest".into(), ports: vec!["3000:3000".into()], env: vec!["NEXTAUTH_URL=http://localhost:3000".into(), "DATABASE_URL=file:/data/typebot.db".into()], volumes: vec!["typebot_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "wagtail".into(), name: "Wagtail".into(), icon: "🐦".into(), category: "CMS".into(),
            ...
            docker: Some(DockerTarget { image: "wagtail/wagtail:latest".into(), ports: vec!["8000:8000".into()], env: vec![], volumes: vec!["wagtail_data:/app/media".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "grav".into(), name: "Grav".into(), icon: "🚀".into(), category: "CMS".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/grav:latest".into(), ports: vec!["8080:80".into()], env: vec!["PUID=1000".into(), "PGID=1000".into()], volumes: vec!["grav_config:/config".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "keystone".into(), name: "KeystoneJS".into(), icon: "🔑".into(), category: "CMS".into(),
            ...
            docker: Some(DockerTarget { image: "keystonejs/keystone:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec!["keystone_data:/app/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "apache".into(), name: "Apache HTTP Server".into(), icon: "🪶".into(), category: "Web".into(),
            ...
            docker: Some(DockerTarget { image: "httpd:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["apache_htdocs:/usr/local/apache2/htdocs".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "lighttpd".into(), name: "lighttpd".into(), icon: "💡".into(), category: "Web".into(),
            ...
            docker: Some(DockerTarget { image: "sebp/lighttpd:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["lighttpd_htdocs:/var/www/localhost/htdocs".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "staticweb".into(), name: "Static Web Server".into(), icon: "📄".into(), category: "Web".into(),
            ...
            docker: Some(DockerTarget { image: "joseluisq/static-web-server:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["${WEB_ROOT}:/public:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "whoogle".into(), name: "Whoogle".into(), icon: "🔍".into(), category: "Privacy".into(),
            ...
            docker: Some(DockerTarget { image: "benbusby/whoogle-search:latest".into(), ports: vec!["5000:5000".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "librex".into(), name: "LibreX".into(), icon: "🔎".into(), category: "Privacy".into(),
            ...
            docker: Some(DockerTarget { image: "librex/librex:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "nitter".into(), name: "Nitter".into(), icon: "🐦".into(), category: "Privacy".into(),
            ...
            docker: Some(DockerTarget { image: "zedeus/nitter:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "teddit".into(), name: "Teddit".into(), icon: "🔶".into(), category: "Privacy".into(),
            ...
            docker: Some(DockerTarget { image: "teddit/teddit:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "rimgo".into(), name: "Rimgo".into(), icon: "🖼️".into(), category: "Privacy".into(),
            ...
            docker: Some(DockerTarget { image: "codeberg.org/video-hierarchie/rimgo:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "text-gen-webui".into(), name: "Text Generation WebUI".into(), icon: "💬".into(), category: "AI / ML".into(),
            ...
            docker: Some(DockerTarget { image: "atinoda/text-generation-webui:default-cpu".into(), ports: vec!["7860:7860".into(), "5000:5000".into()], env: vec![], volumes: vec!["textgen_models:/app/models".into(), "textgen_loras:/app/loras".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "jan".into(), name: "Jan".into(), icon: "🧠".into(), category: "AI / ML".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/janhq/jan:latest".into(), ports: vec!["1337:1337".into()], env: vec![], volumes: vec!["jan_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "langflow".into(), name: "Langflow".into(), icon: "🔗".into(), category: "AI / ML".into(),
            ...
            docker: Some(DockerTarget { image: "langflowai/langflow:latest".into(), ports: vec!["7860:7860".into()], env: vec![], volumes: vec!["langflow_data:/app/langflow".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "anything-llm".into(), name: "AnythingLLM".into(), icon: "🤖".into(), category: "AI / ML".into(),
            ...
            docker: Some(DockerTarget { image: "mintplexlabs/anythingllm:latest".into(), ports: vec!["3001:3001".into()], env: vec![], volumes: vec!["anythingllm_data:/app/server/storage".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "homepage".into(), name: "Homepage".into(), icon: "🏠".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/gethomepage/homepage:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec!["homepage_config:/app/config".into(), "/var/run/docker.sock:/var/run/docker.sock:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "homarr".into(), name: "Homarr".into(), icon: "🏡".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/ajnart/homarr:latest".into(), ports: vec!["7575:7575".into()], env: vec![], volumes: vec!["homarr_config:/app/data/configs".into(), "homarr_icons:/app/public/icons".into(), "/var/run/docker.sock:/var/run/docker.sock:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "dashy".into(), name: "Dashy".into(), icon: "🚀".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "lissy93/dashy:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["dashy_config:/app/user-data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "flame".into(), name: "Flame".into(), icon: "🔥".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "pawelmalak/flame:latest".into(), ports: vec!["5005:5005".into()], env: vec![], volumes: vec!["flame_data:/app/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "linkding".into(), name: "Linkding".into(), icon: "🔗".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "sissbruecker/linkding:latest".into(), ports: vec!["9090:9090".into()], env: vec![], volumes: vec!["linkding_data:/etc/linkding/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "cyberchef".into(), name: "CyberChef".into(), icon: "🧑‍🍳".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "mpepping/cyberchef:latest".into(), ports: vec!["8000:8000".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "snapdrop".into(), name: "Snapdrop".into(), icon: "📲".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/snapdrop:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "pairdrop".into(), name: "PairDrop".into(), icon: "📤".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/pairdrop:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "send".into(), name: "Send".into(), icon: "📨".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "registry.gitlab.com/timvisee/send:latest".into(), ports: vec!["1443:1443".into()], env: vec![], volumes: vec!["send_uploads:/uploads".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "privatebin".into(), name: "PrivateBin".into(), icon: "📋".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "privatebin/nginx-fpm-alpine:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["privatebin_data:/srv/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "rustdesk".into(), name: "RustDesk Server".into(), icon: "🖥️".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "rustdesk/rustdesk-server:latest".into(), ports: vec!["21115:21115".into(), "21116:21116".into(), "21116:21116/udp".into(), "21117:21117".into(), "21118:21118".into(), "21119:21119".into()], env: vec![], volumes: vec!["rustdesk_data:/root".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "meshcentral".into(), name: "MeshCentral".into(), icon: "🌐".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/ylianst/meshcentral:latest".into(), ports: vec!["8086:443".into()], env: vec![], volumes: vec!["meshcentral_data:/opt/meshcentral/meshcentral-data".into(), "meshcentral_files:/opt/meshcentral/meshcentral-files".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "guacamole".into(), name: "Apache Guacamole".into(), icon: "🥑".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "guacamole/guacamole:latest".into(), ports: vec!["8080:8080".into()], env: vec!["GUACD_HOSTNAME=guacamole-guacd".into()], volumes: vec![], sidecars: vec![DockerSidecar { name_suffix: "guacd".into(), image: "guacamole/guacd:latest".into(), ports: vec![], env: vec![], volumes: vec![] }] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "crafty".into(), name: "Crafty Controller".into(), icon: "⛏️".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "registry.gitlab.com/crafty-controller/crafty-4:latest".into(), ports: vec!["8443:8443".into(), "25565:25565".into()], env: vec![], volumes: vec!["crafty_data:/crafty/data".into(), "crafty_servers:/crafty/servers".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "pterodactyl".into(), name: "Pterodactyl Panel".into(), icon: "🦖".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/pterodactyl/panel:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["pterodactyl_data:/app/var".into(), "pterodactyl_nginx:/etc/nginx/http.d".into(), "pterodactyl_logs:/app/storage/logs".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "pelican".into(), name: "Pelican Panel".into(), icon: "🐦".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/pelican-dev/panel:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["pelican_data:/app/var".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "linuxgsm".into(), name: "LinuxGSM".into(), icon: "🎮".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "gameservermanagers/linuxgsm-docker:latest".into(), ports: vec!["27015:27015".into(), "27015:27015/udp".into()], env: vec!["GAMESERVER=${GAME}".into()], volumes: vec!["linuxgsm_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "enshrouded".into(), name: "Enshrouded".into(), icon: "⚔️".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "sknnr/enshrouded-dedicated-server:latest".into(), ports: vec!["15636:15636/udp".into(), "15637:15637/udp".into()], env: vec!["SERVER_NAME=${SERVER_NAME}".into(), "SERVER_PASSWORD=${SERVER_PASS}".into()], volumes: vec!["enshrouded_data:/home/steam/enshrouded".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "vrising".into(), name: "V Rising".into(), icon: "🧛".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "trueosiris/vrising:latest".into(), ports: vec!["9876:9876/udp".into(), "9877:9877/udp".into()], env: vec!["SERVER_NAME=${SERVER_NAME}".into()], volumes: vec!["vrising_data:/mnt/vrising/server".into(), "vrising_saves:/mnt/vrising/persistentdata".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "vintage-story".into(), name: "Vintage Story".into(), icon: "🏕️".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "devidian/vintagestory:latest".into(), ports: vec!["42420:42420".into()], env: vec![], volumes: vec!["vintagestory_data:/gamedata".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "corekeeper".into(), name: "Core Keeper".into(), icon: "⛏️".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "escaping/core-keeper-dedicated:latest".into(), ports: vec![], env: vec!["WORLD_NAME=${WORLD_NAME}".into()], volumes: vec!["corekeeper_data:/home/steam/core-keeper-dedicated".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "rancher".into(), name: "Rancher".into(), icon: "🐄".into(), category: "Container Orchestration".into(),
            ...
            docker: Some(DockerTarget { image: "rancher/rancher:latest".into(), ports: vec!["8443:443".into()], env: vec![], volumes: vec!["rancher_data:/var/lib/rancher".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "k3s".into(), name: "K3s".into(), icon: "⚓".into(), category: "Container Orchestration".into(),
            ...
            website: Some("https://k3s.io".into()),
            docker: Some(DockerTarget { image: "rancher/k3s:latest".into(), ports: vec!["6443:6443".into(), "8080:80".into(), "8443:443".into()], env: vec![], volumes: vec!["k3s_data:/var/lib/rancher/k3s".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "kubero".into(), name: "Kubero".into(), icon: "🐙".into(), category: "PaaS".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/kubero-dev/kubero:latest".into(), ports: vec!["2000:2000".into()], env: vec![], volumes: vec!["kubero_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "homer".into(), name: "Homer".into(), icon: "🏠".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "b4bz/homer:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["homer_assets:/www/assets".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "organizr".into(), name: "Organizr".into(), icon: "📱".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "organizr/organizr:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["organizr_config:/config".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "tasks-md".into(), name: "tasks.md".into(), icon: "✅".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "baldissaramatworkhub/tasks.md:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["tasksmd_data:/tasks".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "traggo".into(), name: "Traggo".into(), icon: "⏲️".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "traggo/server:latest".into(), ports: vec!["3030:3030".into()], env: vec!["TRAGGO_DEFAULT_USER_NAME=admin".into(), "TRAGGO_DEFAULT_USER_PASS=${ADMIN_PASSWORD}".into()], volumes: vec!["traggo_data:/opt/traggo/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "ADMIN_PASSWORD".into(), label: "Admin Password".into(), input_type: "password".into(), default: None, required: true, placeholder: Some("Admin password".into()), options: vec![] },
            ],
        },
        AppManifest { id: "kopia".into(), name: "Kopia".into(), icon: "📦".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "kopia/kopia:latest".into(), ports: vec!["51515:51515".into()], env: vec!["KOPIA_PASSWORD=${REPO_PASSWORD}".into()], volumes: vec!["kopia_config:/app/config".into(), "kopia_cache:/app/cache".into(), "kopia_logs:/app/logs".into(), "${BACKUP_SOURCE}:/data:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "restic-rest".into(), name: "Restic REST Server".into(), icon: "💾".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "restic/rest-server:latest".into(), ports: vec!["8000:8000".into()], env: vec![], volumes: vec!["restic_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "browserless".into(), name: "Browserless".into(), icon: "🌐".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "browserless/chrome:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "memos".into(), name: "Memos".into(), icon: "📝".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "neosmemo/memos:stable".into(), ports: vec!["5230:5230".into()], env: vec![], volumes: vec!["memos_data:/var/opt/memos".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "flatnotes".into(), name: "Flatnotes".into(), icon: "📒".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "dullage/flatnotes:latest".into(), ports: vec!["8080:8080".into()], env: vec!["FLATNOTES_AUTH_TYPE=password".into(), "FLATNOTES_USERNAME=admin".into(), "FLATNOTES_PASSWORD=${ADMIN_PASSWORD}".into()], volumes: vec!["flatnotes_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "bentos".into(), name: "Bento".into(), icon: "🍱".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "lewisdoesstuff/bento:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "littlelink".into(), name: "LittleLink".into(), icon: "🔗".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/techno-tim/littlelink-server:latest".into(), ports: vec!["8080:3000".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "shlink".into(), name: "Shlink".into(), icon: "🔗".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "shlinkio/shlink:stable".into(), ports: vec!["8080:8080".into()], env: vec!["DEFAULT_DOMAIN=localhost:8080".into(), "IS_HTTPS_ENABLED=false".into()], volumes: vec!["shlink_data:/etc/shlink/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "lldap".into(), name: "LLDAP".into(), icon: "👥".into(), category: "Security".into(),
            ...
            docker: Some(DockerTarget { image: "lldap/lldap:latest".into(), ports: vec!["3890:3890".into(), "17170:17170".into()], env: vec!["LLDAP_LDAP_BASE_DN=dc=example,dc=com".into(), "LLDAP_JWT_SECRET=${JWT_SECRET}".into()], volumes: vec!["lldap_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "vault".into(), name: "HashiCorp Vault".into(), icon: "🔐".into(), category: "Security".into(),
            ...
            docker: Some(DockerTarget { image: "hashicorp/vault:latest".into(), ports: vec!["8200:8200".into()], env: vec!["VAULT_DEV_ROOT_TOKEN_ID=${ROOT_TOKEN}".into()], volumes: vec!["vault_data:/vault/file".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "step-ca".into(), name: "Smallstep CA".into(), icon: "🔏".into(), category: "Security".into(),
            ...
            docker: Some(DockerTarget { image: "smallstep/step-ca:latest".into(), ports: vec!["9000:9000".into()], env: vec![], volumes: vec!["step_ca_data:/home/step".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "owncast".into(), name: "Owncast".into(), icon: "📡".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "owncast/owncast:latest".into(), ports: vec!["8080:8080".into(), "1935:1935".into()], env: vec![], volumes: vec!["owncast_data:/app/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "medusa".into(), name: "Medusa".into(), icon: "📺".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/medusa:latest".into(), ports: vec!["8081:8081".into()], env: vec!["PUID=1000".into(), "PGID=1000".into()], volumes: vec!["medusa_config:/config".into(), "${MEDIA_PATH}:/tv".into(), "${DOWNLOAD_PATH}:/downloads".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "sabnzbd".into(), name: "SABnzbd".into(), icon: "📥".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/sabnzbd:latest".into(), ports: vec!["8080:8080".into()], env: vec!["PUID=1000".into(), "PGID=1000".into()], volumes: vec!["sabnzbd_config:/config".into(), "${DOWNLOAD_PATH}:/downloads".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "DOWNLOAD_PATH".into(), label: "Downloads Path".into(), input_type: "text".into(), default: Some("/opt/downloads".into()), required: true, placeholder: None, options: vec![] },
            ],
        },
        AppManifest { id: "transmission".into(), name: "Transmission".into(), icon: "🔽".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/transmission:latest".into(), ports: vec!["9091:9091".into(), "51413:51413".into(), "51413:51413/udp".into()], env: vec!["PUID=1000".into(), "PGID=1000".into()], volumes: vec!["transmission_config:/config".into(), "${DOWNLOAD_PATH}:/downloads".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "DOWNLOAD_PATH".into(), label: "Downloads Path".into(), input_type: "text".into(), default: Some("/opt/downloads".into()), required: true, placeholder: None, options: vec![] },
            ],
        },
        AppManifest { id: "qbittorrent".into(), name: "qBittorrent".into(), icon: "🔽".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/qbittorrent:latest".into(), ports: vec!["8080:8080".into(), "6881:6881".into(), "6881:6881/udp".into()], env: vec!["PUID=1000".into(), "PGID=1000".into()], volumes: vec!["qbittorrent_config:/config".into(), "${DOWNLOAD_PATH}:/downloads".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "DOWNLOAD_PATH".into(), label: "Downloads Path".into(), input_type: "text".into(), default: Some("/opt/downloads".into()), required: true, placeholder: None, options: vec![] },
            ],
        },
        AppManifest { id: "jackett".into(), name: "Jackett".into(), icon: "🧥".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/jackett:latest".into(), ports: vec!["9117:9117".into()], env: vec!["PUID=1000".into(), "PGID=1000".into()], volumes: vec!["jackett_config:/config".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "flaresolverr".into(), name: "FlareSolverr".into(), icon: "☁️".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/flaresolverr/flaresolverr:latest".into(), ports: vec!["8191:8191".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "requestrr".into(), name: "Requestrr".into(), icon: "🤖".into(), category: "Media".into(),
            ...
            docker: Some(DockerTarget { image: "darkalfx/requestrr:latest".into(), ports: vec!["4545:4545".into()], env: vec![], volumes: vec!["requestrr_config:/root/config".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "papermerge".into(), name: "Papermerge".into(), icon: "📄".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "papermerge/papermerge:latest".into(), ports: vec!["12000:80".into()], env: vec![], volumes: vec!["papermerge_data:/var/media".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "drawio".into(), name: "draw.io".into(), icon: "📐".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "jgraph/drawio:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "etherpad".into(), name: "Etherpad".into(), icon: "📝".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "etherpad/etherpad:latest".into(), ports: vec!["9001:9001".into()], env: vec![], volumes: vec!["etherpad_data:/opt/etherpad-lite/var".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "weblate".into(), name: "Weblate".into(), icon: "🌍".into(), category: "Productivity".into(),
            ...
            docker: Some(DockerTarget { image: "weblate/weblate:latest".into(), ports: vec!["8080:8080".into()], env: vec!["WEBLATE_ADMIN_PASSWORD=${ADMIN_PASSWORD}".into(), "POSTGRES_HOST=weblate-db".into(), "POSTGRES_PASSWORD=${DB_PASSWORD}".into()], volumes: vec!["weblate_data:/app/data".into()], sidecars: vec![DockerSidecar { name_suffix: "db".into(), image: "postgres:15-alpine".into(), ports: vec![], env: vec!["POSTGRES_PASSWORD=${DB_PASSWORD}".into()], volumes: vec!["weblate_db:/var/lib/postgresql/data".into()] }] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "harbor".into(), name: "Harbor".into(), icon: "⚓".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "goharbor/harbor-core:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["harbor_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "nexus".into(), name: "Sonatype Nexus".into(), icon: "📦".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "sonatype/nexus3:latest".into(), ports: vec!["8081:8081".into()], env: vec![], volumes: vec!["nexus_data:/nexus-data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "minio-console".into(), name: "MinIO Console".into(), icon: "💿".into(), category: "Dev Tools".into(),
            ...
            website: Some("https://min.io".into()),
            docker: Some(DockerTarget { image: "minio/console:latest".into(), ports: vec!["9090:9090".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "pypiserver".into(), name: "PyPI Server".into(), icon: "🐍".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "pypiserver/pypiserver:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["pypi_packages:/data/packages".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "renovate".into(), name: "Renovate".into(), icon: "🔄".into(), category: "Dev Tools".into(),
            ...
            docker: Some(DockerTarget { image: "renovate/renovate:latest".into(), ports: vec![], env: vec!["RENOVATE_TOKEN=${GIT_TOKEN}".into()], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "unifi".into(), name: "UniFi Controller".into(), icon: "📶".into(), category: "Networking".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/unifi-network-application:latest".into(), ports: vec!["8443:8443".into(), "3478:3478/udp".into(), "10001:10001/udp".into(), "8080:8080".into()], env: vec!["PUID=1000".into(), "PGID=1000".into()], volumes: vec!["unifi_config:/config".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "omada".into(), name: "TP-Link Omada Controller".into(), icon: "📶".into(), category: "Networking".into(),
            ...
            docker: Some(DockerTarget { image: "mbentley/omada-controller:latest".into(), ports: vec!["8088:8088".into(), "8043:8043".into(), "27001:27001/udp".into(), "27002:27002".into()], env: vec!["TZ=UTC".into()], volumes: vec!["omada_data:/opt/tplink/EAPController/data".into(), "omada_logs:/opt/tplink/EAPController/logs".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "netbox".into(), name: "NetBox".into(), icon: "🗺️".into(), category: "Networking".into(),
            ...
            docker: Some(DockerTarget { image: "netboxcommunity/netbox:latest".into(), ports: vec!["8080:8080".into()], env: vec!["SUPERUSER_NAME=admin".into(), "SUPERUSER_PASSWORD=${ADMIN_PASSWORD}".into(), "SUPERUSER_EMAIL=admin@example.com".into()], volumes: vec!["netbox_media:/opt/netbox/netbox/media".into()], sidecars: vec![DockerSidecar { name_suffix: "db".into(), image: "postgres:15-alpine".into(), ports: vec![], env: vec!["POSTGRES_DB=netbox".into(), "POSTGRES_USER=netbox".into(), "POSTGRES_PASSWORD=${DB_PASSWORD}".into()], volumes: vec!["netbox_db:/var/lib/postgresql/data".into()] }] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "librespeed".into(), name: "LibreSpeed".into(), icon: "⚡".into(), category: "Networking".into(),
            ...
            docker: Some(DockerTarget { image: "linuxserver/librespeed:latest".into(), ports: vec!["8080:80".into()], env: vec!["PUID=1000".into(), "PGID=1000".into()], volumes: vec!["librespeed_config:/config".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "keeweb".into(), name: "KeeWeb".into(), icon: "🔑".into(), category: "Security".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/keeweb/keeweb:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "grype".into(), name: "Grype".into(), icon: "🔍".into(), category: "Security".into(),
            ...
            docker: Some(DockerTarget { image: "anchore/grype:latest".into(), ports: vec![], env: vec![], volumes: vec!["grype_db:/root/.cache/grype".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "grafana-alloy".into(), name: "Grafana Alloy".into(), icon: "📊".into(), category: "Monitoring".into(),
            ...
            docker: Some(DockerTarget { image: "grafana/alloy:latest".into(), ports: vec!["12345:12345".into()], env: vec![], volumes: vec!["alloy_data:/var/lib/alloy".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "alertmanager".into(), name: "Alertmanager".into(), icon: "🚨".into(), category: "Monitoring".into(),
            ...
            docker: Some(DockerTarget { image: "prom/alertmanager:latest".into(), ports: vec!["9093:9093".into()], env: vec![], volumes: vec!["alertmanager_data:/alertmanager".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "jaeger".into(), name: "Jaeger".into(), icon: "🔎".into(), category: "Monitoring".into(),
            ...
            docker: Some(DockerTarget { image: "jaegertracing/all-in-one:latest".into(), ports: vec!["16686:16686".into(), "14268:14268".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "zipkin".into(), name: "Zipkin".into(), icon: "🔬".into(), category: "Monitoring".into(),
            ...
            docker: Some(DockerTarget { image: "openzipkin/zipkin:latest".into(), ports: vec!["9411:9411".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "healthcheck-ping".into(), name: "Healthchecks.io (self-hosted)".into(), icon: "🏓".into(), category: "Automation".into(),
            ...
            website: Some("https://healthchecks.io".into()),
            docker: Some(DockerTarget { image: "healthchecks/healthchecks:latest".into(), ports: vec!["8000:8000".into()], env: vec!["SECRET_KEY=${SECRET_KEY}".into(), "ALLOWED_HOSTS=*".into()], volumes: vec!["healthchecks_v2_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "kestra".into(), name: "Kestra".into(), icon: "🌊".into(), category: "Automation".into(),
            ...
            docker: Some(DockerTarget { image: "kestra/kestra:latest".into(), ports: vec!["8080:8080".into(), "8081:8081".into()], env: vec![], volumes: vec!["kestra_data:/app/storage".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "discourse".into(), name: "Discourse".into(), icon: "💬".into(), category: "Communication".into(),
            ...
            docker: Some(DockerTarget { image: "discourse/discourse:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["discourse_data:/shared".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "flarum".into(), name: "Flarum".into(), icon: "💬".into(), category: "Communication".into(),
            ...
            docker: Some(DockerTarget { image: "crazymax/flarum:latest".into(), ports: vec!["8000:8000".into()], env: vec!["FLARUM_BASE_URL=http://localhost:8000".into()], volumes: vec!["flarum_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "chatwoot".into(), name: "Chatwoot".into(), icon: "💬".into(), category: "Communication".into(),
            ...
            docker: Some(DockerTarget { image: "chatwoot/chatwoot:latest".into(), ports: vec!["3000:3000".into()], env: vec!["SECRET_KEY_BASE=${SECRET_KEY}".into(), "FRONTEND_URL=http://localhost:3000".into()], volumes: vec!["chatwoot_data:/app/storage".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "SECRET_KEY".into(), label: "Secret Key".into(), input_type: "password".into(), default: None, required: true, placeholder: Some("Long random string".into()), options: vec![] },
            ],
        },
        ...
        AppManifest { id: "hugo".into(), name: "Hugo".into(), icon: "📝".into(), category: "CMS".into(),
            ...
            docker: Some(DockerTarget { image: "klakegg/hugo:latest".into(), ports: vec!["1313:1313".into()], env: vec![], volumes: vec!["hugo_site:/src".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "writefreely".into(), name: "WriteFreely".into(), icon: "✍️".into(), category: "CMS".into(),
            ...
            docker: Some(DockerTarget { image: "writeas/writefreely:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["writefreely_data:/go/keys".into(), "writefreely_db:/go/db".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "privateGPT".into(), name: "PrivateGPT".into(), icon: "🔒".into(), category: "AI / ML".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/zylon-ai/private-gpt:latest".into(), ports: vec!["8001:8001".into()], env: vec![], volumes: vec!["privategpt_data:/home/worker/app/local_data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "litellm".into(), name: "LiteLLM".into(), icon: "⚡".into(), category: "AI / ML".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/berriai/litellm:main-latest".into(), ports: vec!["4000:4000".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "label-studio".into(), name: "Label Studio".into(), icon: "🏷️".into(), category: "AI / ML".into(),
            ...
            docker: Some(DockerTarget { image: "heartexlabs/label-studio:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["labelstudio_data:/label-studio/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "jupyter".into(), name: "Jupyter Notebook".into(), icon: "📓".into(), category: "AI / ML".into(),
            ...
            docker: Some(DockerTarget { image: "jupyter/scipy-notebook:latest".into(), ports: vec!["8888:8888".into()], env: vec![], volumes: vec!["jupyter_work:/home/jovyan/work".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "mlflow".into(), name: "MLflow".into(), icon: "📊".into(), category: "AI / ML".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/mlflow/mlflow:latest".into(), ports: vec!["5000:5000".into()], env: vec![], volumes: vec!["mlflow_data:/mlflow".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "photostructure".into(), name: "PhotoStructure".into(), icon: "🖼️".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "photostructure/server:latest".into(), ports: vec!["1787:1787".into()], env: vec![], volumes: vec!["photostructure_lib:/ps/library".into(), "${PHOTOS_PATH}:/ps/scan:ro".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "PHOTOS_PATH".into(), label: "Photos Path".into(), input_type: "text".into(), default: Some("/opt/photos".into()), required: true, placeholder: None, options: vec![] },
            ],
        },
        ...
        AppManifest { id: "openspeedtest".into(), name: "OpenSpeedTest".into(), icon: "🏎️".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "openspeedtest/latest:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "whoami".into(), name: "Whoami".into(), icon: "❓".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "traefik/whoami:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec![], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "answer".into(), name: "Answer".into(), icon: "❓".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "answerdev/answer:latest".into(), ports: vec!["9080:80".into()], env: vec![], volumes: vec!["answer_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "maybe".into(), name: "Maybe".into(), icon: "💸".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "ghcr.io/maybe-finance/maybe:latest".into(), ports: vec!["3000:3000".into()], env: vec![], volumes: vec!["maybe_data:/rails/storage".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "actual-budget".into(), name: "Actual Budget".into(), icon: "💰".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "actualbudget/actual-server:latest".into(), ports: vec!["5006:5006".into()], env: vec![], volumes: vec!["actual_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "firefly".into(), name: "Firefly III".into(), icon: "🔥".into(), category: "Other".into(),
            ...
            docker: Some(DockerTarget { image: "fireflyiii/core:latest".into(), ports: vec!["8080:8080".into()], env: vec!["APP_KEY=${APP_KEY}".into(), "DB_CONNECTION=sqlite".into(), "DB_DATABASE=/var/www/html/storage/database/database.sqlite".into()], volumes: vec!["firefly_upload:/var/www/html/storage/upload".into(), "firefly_db:/var/www/html/storage/database".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "foundry-vtt".into(), name: "Foundry VTT".into(), icon: "🎲".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "felddy/foundryvtt:release".into(), ports: vec!["30000:30000".into()], env: vec!["FOUNDRY_USERNAME=${FOUNDRY_USER}".into(), "FOUNDRY_PASSWORD=${FOUNDRY_PASS}".into()], volumes: vec!["foundryvtt_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "avorion".into(), name: "Avorion".into(), icon: "🚀".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "rfvgyhn/avorion:latest".into(), ports: vec!["27000:27000".into(), "27003:27003".into(), "27020:27020".into(), "27021:27021".into()], env: vec![], volumes: vec!["avorion_data:/home/steam/avorion-server".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "stationeers".into(), name: "Stationeers".into(), icon: "🛸".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "hetsh/stationeers:latest".into(), ports: vec!["27016:27016/udp".into()], env: vec!["WORLD_NAME=${WORLD_NAME}".into()], volumes: vec!["stationeers_data:/stationeers".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "unturned".into(), name: "Unturned".into(), icon: "🧟".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "cm2network/unturned:latest".into(), ports: vec!["27015:27015/udp".into(), "27016:27016/udp".into()], env: vec![], volumes: vec!["unturned_data:/home/steam/unturned-dedicated".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        AppManifest { id: "dont-starve".into(), name: "Don't Starve Together".into(), icon: "🔥".into(), category: "Gaming".into(),
            ...
            docker: Some(DockerTarget { image: "jamesits/dst-server:latest".into(), ports: vec!["10999:10999/udp".into()], env: vec!["DST_CLUSTER_TOKEN=${CLUSTER_TOKEN}".into()], volumes: vec!["dst_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "openproject".into(), name: "OpenProject".into(), icon: "📊".into(), category: "Project Management".into(),
            ...
            docker: Some(DockerTarget { image: "openproject/openproject:latest".into(), ports: vec!["8080:80".into()], env: vec!["OPENPROJECT_SECRET_KEY_BASE=${SECRET_KEY}".into()], volumes: vec!["openproject_pgdata:/var/openproject/pgdata".into(), "openproject_assets:/var/openproject/assets".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
                UserInput { id: "SECRET_KEY".into(), label: "Secret Key".into(), input_type: "password".into(), default: None, required: true, placeholder: Some("Random secret string".into()), options: vec![] },
            ],
        },
        AppManifest { id: "kanboard".into(), name: "Kanboard".into(), icon: "📌".into(), category: "Project Management".into(),
            ...
            docker: Some(DockerTarget { image: "kanboard/kanboard:latest".into(), ports: vec!["8080:80".into()], env: vec![], volumes: vec!["kanboard_data:/var/www/app/data".into(), "kanboard_plugins:/var/www/app/plugins".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "goatcounter".into(), name: "GoatCounter".into(), icon: "🐐".into(), category: "Analytics".into(),
            ...
            docker: Some(DockerTarget { image: "baethon/goatcounter:latest".into(), ports: vec!["8080:8080".into()], env: vec![], volumes: vec!["goatcounter_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "fathom".into(), name: "Fathom Lite".into(), icon: "📊".into(), category: "Analytics".into(),
            ...
            docker: Some(DockerTarget { image: "usefathom/fathom:latest".into(), ports: vec!["8080:8080".into()], env: vec!["FATHOM_SERVER_ADDR=:8080".into()], volumes: vec!["fathom_data:/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "buildkite-agent".into(), name: "Buildkite Agent".into(), icon: "🏗️".into(), category: "CI/CD".into(),
            ...
            docker: Some(DockerTarget { image: "buildkite/agent:latest".into(), ports: vec![], env: vec!["BUILDKITE_AGENT_TOKEN=${AGENT_TOKEN}".into()], volumes: vec!["buildkite_builds:/buildkite/builds".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![
        ...
        AppManifest { id: "piku".into(), name: "Piku".into(), icon: "🐡".into(), category: "PaaS".into(),
            ...
            docker: Some(DockerTarget { image: "piku/piku:latest".into(), ports: vec!["9080:80".into(), "2222:22".into()], env: vec![], volumes: vec!["piku_data:/home/piku".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
        ...
        AppManifest { id: "consul".into(), name: "HashiCorp Consul".into(), icon: "🏛️".into(), category: "Container Orchestration".into(),
            ...
            docker: Some(DockerTarget { image: "hashicorp/consul:latest".into(), ports: vec!["8500:8500".into(), "8600:8600/udp".into()], env: vec![], volumes: vec!["consul_data:/consul/data".into()], sidecars: vec![] }),
            lxc: None, bare_metal: None, user_inputs: vec![],
        },
